...
%		1. $AG((open * ~up * ~down) \to (open))$ 		&	If the lock is open and it is not interrupted, it can remain open indefinitely.		 		\\\hline
%%		2. RadioShack\textsuperscript{\textregistered} Standard Servo		&	180\degree rotation 			\\\hline
